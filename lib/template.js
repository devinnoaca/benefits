        ...
        <div class="col-lg-4 col-sm-6 mb-5">
          <div class="partner-item">
            <a class="partner-link" data-toggle="modal" id="${i.id}" href="#portfolio-${i.id}">
              ...
              <img class="img-fluid" src="assets/img/portfolio/${i.id}.png" alt="" />
            </a>
                ...
                <div class="row justify-content-center">
                  <div class="col-lg-8">
                    <div class="modal-body">
                      ...
                      <p class="text-break" style="text-align: left;">${joinText}
                        ${makeButton}
                      </p>
                    </div>
                  </div>
                  <img class="img-fluid d-block mx-auto" src="assets/img/portfolio/${i.id}-portfolio.png" alt="" />
                  <div class="col-lg-8">
                    <div class="modal-body">
